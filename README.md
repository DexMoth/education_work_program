...
* после открытия страницы "Рабочие программы" обнови страницу, чтобы загрузились фильтры для зав. кафедры. я так и не поняла, почему они автоматически не грузятся :D