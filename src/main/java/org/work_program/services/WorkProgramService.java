...
public class WorkProgramService {
    ...
    public WorkProgramModel update(Long id,  WorkProgramModel entity) {
        ...
        el.setThematicPlan(entity.getThematicPlan());
        ...
        el.setTheoreticalCourse(entity.getTheoreticalCourse());
        el.setPracticalWork(entity.getPracticalWork());
        el.setLaboratoryWorkshop(entity.getLaboratoryWorkshop());
        el.setCourseProject(entity.getCourseProject());
        el.setIndependentWork(entity.getIndependentWork());
    ...
    public List<WorkProgramModel> getFilteredWorkPrograms(Long departmentId, Long curriculumId) {
        if (departmentId != null && curriculumId == null) {
            ...
            return repository.findByStudyDirection(curriculumId);
        }
        else if (departmentId != null && curriculumId != null) {
            return repository.findByDepartmentAndStudyDirection(departmentId, curriculumId);
        }
        else {
